...
#define TRADE_NOMOUNTEBANK (1 << 3)
#define TRADE_NOAETHERIST     (1 << 4)
#define TRADE_NODRIFTER      (1 << 5)
#define TRADE_NOOUTRIDER    (1 << 6)
#define TRADE_NOHUMAN      (1 << 7)
#define TRADE_NOSMALLKIN   (1 << 8)
#define TRADE_NOWYRM       (1 << 9)
#define TRADE_NOUNDEAD     (1 << 10)
...
#define NOTRADE_MOUNTEBANK(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMOUNTEBANK))
#define NOTRADE_AETHERIST(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOAETHERIST))
#define NOTRADE_DRIFTER(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NODRIFTER))
#define NOTRADE_OUTRIDER(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOOUTRIDER))
#define NOTRADE_HUMAN(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOHUMAN))
#define NOTRADE_SMALLKIN(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOSMALLKIN))
#define NOTRADE_WYRM(i)    (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOWYRM))
...
#define MSG_NO_SELL_RACE      "I don't cater to you people."
