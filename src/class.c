...
"{}-------------------------------------------{}\r\n"
"|| {\t(1\t)} mountebank - a trickster, a charlatan ||\r\n"
"|| {\t(2\t)} aetherist  - a manipulator of energy  ||\r\n"
"|| {\t(3\t)} drifter    - an itinerant vagabond    ||\r\n"
"|| {\t(4\t)} outrider   - an independent pioneer   ||\r\n"
...
int parse_class(char arg)
{
  ...
  switch (arg) {
  case '1': return CLASS_MOUNTEBANK;
 ...
 * that from room 3017, only MOUNTEBANKS are allowed to go south. Don't forget
...
byte saving_throws(int class_num, int type, int level)
{
  ...
  case CLASS_MOUNTEBANK:
    ...
    case SAVING_PARA:	/* Paralyzation */
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for MOUNTEBANK paralyzation saving throw.");
	break;
      }
    case SAVING_ROD:	/* Rods */
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for MOUNTEBANK rod saving throw.");
	break;
      }
    case SAVING_PETRI:	/* Petrification */
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for MOUNTEBANK petrification saving throw.");
	break;
      }
    case SAVING_BREATH:	/* Breath weapons */
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for MOUNTEBANK breath saving throw.");
	break;
      }
    case SAVING_SPELL:	/* Generic spells */
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for MOUNTEBANK spell saving throw.");
	break;
      }
    default:
  ...
  case CLASS_AETHERIST:
    ...
    case SAVING_PARA:	/* Paralyzation */
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for AETHERIST paralyzation saving throw.");
	break;
      }
    case SAVING_ROD:	/* Rods */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for AETHERIST rod saving throw.");
	break;
      }
    case SAVING_PETRI:	/* Petrification */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for AETHERIST petrification saving throw.");
	break;
      }
    case SAVING_BREATH:	/* Breath weapons */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for AETHERIST breath saving throw.");
	break;
      }
    case SAVING_SPELL:	/* Generic spells */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for AETHERIST spell saving throw.");
	break;
      }
    default:
      log("SYSERR: Invalid saving throw type.");
  ...
  case CLASS_DRIFTER:
    ...
    case SAVING_PARA:	/* Paralyzation */
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for DRIFTER paralyzation saving throw.");
	break;
      }
    case SAVING_ROD:	/* Rods */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for DRIFTER rod saving throw.");
	break;
      }
    case SAVING_PETRI:	/* Petrification */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for DRIFTER petrification saving throw.");
	break;
      }
    case SAVING_BREATH:	/* Breath weapons */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for DRIFTER breath saving throw.");
	break;
      }
    case SAVING_SPELL:	/* Generic spells */
      switch (level) {
      ...
      case 40: return  0;
      default:
	log("SYSERR: Missing level for DRIFTER spell saving throw.");
	break;
      }
    default:
      log("SYSERR: Invalid saving throw type.");
  ...
  case CLASS_OUTRIDER:
    ...
    case SAVING_PARA:	/* Paralyzation */
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for OUTRIDER paralyzation saving throw.");
	break;
      }
    case SAVING_ROD:	/* Rods */
      switch (level) {
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for OUTRIDER rod saving throw.");
	break;
      }
    case SAVING_PETRI:	/* Petrification */
      switch (level) {
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for OUTRIDER petrification saving throw.");
	break;
      }
    case SAVING_BREATH:	/* Breath weapons */
      switch (level) {
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for OUTRIDER breath saving throw.");
	break;
      }
    case SAVING_SPELL:	/* Generic spells */
      switch (level) {
      ...
      case 50: return  0;
      default:
	log("SYSERR: Missing level for OUTRIDER spell saving throw.");
	break;
      }
    default:
      log("SYSERR: Invalid saving throw type.");
...
int thaco(int class_num, int level)
{
  ...
  case CLASS_MOUNTEBANK:
    ...
    case 34: return   9;
    default:
      log("SYSERR: Missing level for MOUNTEBANK thac0.");
    }
  case CLASS_AETHERIST:
    switch (level) {
    case  0: return 100;
  ...
  case CLASS_DRIFTER:
    ...
    case 34: return   4;
    default:
      log("SYSERR: Missing level for DRIFTER thac0.");
    }
  case CLASS_OUTRIDER:
    switch (level) {
    case  0: return 100;
...
void advance_level(struct char_data *ch)
{
  ...
  case CLASS_MOUNTEBANK:
    ...
    add_mana = rand_number((int)(GET_LEVEL(ch) - 1), (int)(1.2 * GET_LEVEL(ch)));
  ...
  if (IS_MOUNTEBANK(ch) || IS_AETHERIST(ch))
...
int invalid_class(struct char_data *ch, struct obj_data *obj)
{
  ...
  if (OBJ_FLAGGED(obj, ITEM_ANTI_AETHERIST) && IS_AETHERIST(ch))
    return TRUE;

  if (OBJ_FLAGGED(obj, ITEM_ANTI_OUTRIDER) && IS_OUTRIDER(ch))
    return TRUE;
...
{
  /* MOUNTEBANKS */
  spell_level(SPELL_MAGIC_MISSILE, CLASS_MOUNTEBANK, 1);
  spell_level(SPELL_DETECT_INVIS, CLASS_MOUNTEBANK, 2);
  spell_level(SPELL_DETECT_MAGIC, CLASS_MOUNTEBANK, 2);
  spell_level(SPELL_CHILL_TOUCH, CLASS_MOUNTEBANK, 3);
  spell_level(SPELL_INFRAVISION, CLASS_MOUNTEBANK, 3);
  spell_level(SPELL_INVISIBLE, CLASS_MOUNTEBANK, 4);
  spell_level(SPELL_ARMOR, CLASS_MOUNTEBANK, 4);
  spell_level(SPELL_BURNING_HANDS, CLASS_MOUNTEBANK, 5);
  spell_level(SPELL_LOCATE_OBJECT, CLASS_MOUNTEBANK, 6);
  spell_level(SPELL_STRENGTH, CLASS_MOUNTEBANK, 6);
  spell_level(SPELL_SHOCKING_GRASP, CLASS_MOUNTEBANK, 7);
  spell_level(SPELL_SLEEP, CLASS_MOUNTEBANK, 8);
  spell_level(SPELL_LIGHTNING_BOLT, CLASS_MOUNTEBANK, 9);
  spell_level(SPELL_BLINDNESS, CLASS_MOUNTEBANK, 9);
  spell_level(SPELL_DETECT_POISON, CLASS_MOUNTEBANK, 10);
  spell_level(SPELL_COLOR_SPRAY, CLASS_MOUNTEBANK, 11);
  spell_level(SPELL_ENERGY_DRAIN, CLASS_MOUNTEBANK, 13);
  spell_level(SPELL_CURSE, CLASS_MOUNTEBANK, 14);
  spell_level(SPELL_POISON, CLASS_MOUNTEBANK, 14);
  spell_level(SPELL_FIREBALL, CLASS_MOUNTEBANK, 15);
  spell_level(SPELL_CHARM, CLASS_MOUNTEBANK, 16);
  spell_level(SPELL_IDENTIFY, CLASS_MOUNTEBANK, 20);
  spell_level(SPELL_FLY, CLASS_MOUNTEBANK, 22);
  spell_level(SPELL_ENCHANT_WEAPON, CLASS_MOUNTEBANK, 26);
  spell_level(SPELL_CLONE, CLASS_MOUNTEBANK, 30);

  /* AETHERISTS */
  spell_level(SPELL_CURE_LIGHT, CLASS_AETHERIST, 1);
  spell_level(SPELL_ARMOR, CLASS_AETHERIST, 1);
  spell_level(SPELL_CREATE_FOOD, CLASS_AETHERIST, 2);
  spell_level(SPELL_CREATE_WATER, CLASS_AETHERIST, 2);
  spell_level(SPELL_DETECT_POISON, CLASS_AETHERIST, 3);
  spell_level(SPELL_DETECT_ALIGN, CLASS_AETHERIST, 4);
  spell_level(SPELL_CURE_BLIND, CLASS_AETHERIST, 4);
  spell_level(SPELL_BLESS, CLASS_AETHERIST, 5);
  spell_level(SPELL_DETECT_INVIS, CLASS_AETHERIST, 6);
  spell_level(SPELL_BLINDNESS, CLASS_AETHERIST, 6);
  spell_level(SPELL_INFRAVISION, CLASS_AETHERIST, 7);
  spell_level(SPELL_PROT_FROM_EVIL, CLASS_AETHERIST, 8);
  spell_level(SPELL_POISON, CLASS_AETHERIST, 8);
  spell_level(SPELL_GROUP_ARMOR, CLASS_AETHERIST, 9);
  spell_level(SPELL_CURE_CRITIC, CLASS_AETHERIST, 9);
  spell_level(SPELL_SUMMON, CLASS_AETHERIST, 10);
  spell_level(SPELL_REMOVE_POISON, CLASS_AETHERIST, 10);
  spell_level(SPELL_IDENTIFY, CLASS_AETHERIST, 11);
  spell_level(SPELL_WORD_OF_RECALL, CLASS_AETHERIST, 12);
  spell_level(SPELL_DARKNESS, CLASS_AETHERIST, 12);
  spell_level(SPELL_EARTHQUAKE, CLASS_AETHERIST, 12);
  spell_level(SPELL_DISPEL_EVIL, CLASS_AETHERIST, 14);
  spell_level(SPELL_DISPEL_GOOD, CLASS_AETHERIST, 14);
  spell_level(SPELL_SANCTUARY, CLASS_AETHERIST, 15);
  spell_level(SPELL_CALL_LIGHTNING, CLASS_AETHERIST, 15);
  spell_level(SPELL_HEAL, CLASS_AETHERIST, 16);
  spell_level(SPELL_CONTROL_WEATHER, CLASS_AETHERIST, 17);
  spell_level(SPELL_SENSE_LIFE, CLASS_AETHERIST, 18);
  spell_level(SPELL_HARM, CLASS_AETHERIST, 19);
